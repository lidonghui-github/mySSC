<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
 ...
 <div>
      ...
      <select name="pageSize" onchange="changePageSize(this.value)" style="width: 50px;">
          ...
          <option value="200"   ${pageModel.pageSize==200?"selected":"" }>200</option>
          <option value="500"   ${pageModel.pageSize==500?"selected":"" }>500</option>
          <option value="1000"   ${pageModel.pageSize==1000?"selected":"" }>1000</option>
      </select>  
