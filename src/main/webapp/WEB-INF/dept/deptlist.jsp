...
<body>
 <form class="form-inline definewidth m20" action="dept/query" method="post">    
    关键字：
    <input type="text" name="keywords" id="keywords"class="abc input-default" placeholder="请输入部门名称" value="${vo.keywords }">&nbsp;&nbsp;  
	     ...
	     <tr>
          <%--  <td>${u.deptId } </td>--%>
            ...
            <td>${u.remark }</td>
             ...
             <td>
                <a href="dept/updatePage/${u.deptId }">编辑</a>  
                <a  href="dept/delete/${u.deptId }" onclick="{if(confirm('确认删除?')){return true;}return false;}">删除</a>
            </td>       
        </tr>	
        </c:forEach>
</table>
<form action="dept/query" id="pager" name="pager" method="post">
